declare module 'saxon-js' {
    namespace SaxonJS {
        ...
        function transform(options: Transformation.Options, execution: 'sync'): Transformation.Results;
        function transform(options: Transformation.Options, execution: 'async'): Promise<Transformation.Results>;
        namespace Transformation {
            ...
            interface ResultDelivery {
                ...
                deliverResultDocument: (uri: string) => {
                    destination: 'html-page' | 'raw' | 'document' | 'serialized' | 'file' | 'receiver';
